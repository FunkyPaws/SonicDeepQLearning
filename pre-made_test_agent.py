...
parser.add_argument('--state', default='GreenHillZone.Act1.test', help='the initial state file to load, minus the extension')
...
parser.add_argument('--obs-type', '-o', default='image', choices=['image', 'ram'],
...
env = retro.make(args.game, args.state or retro.State.DEFAULT, scenario=args.scenario, record=args.record,
                 players=args.players, obs_type=obs_type)
