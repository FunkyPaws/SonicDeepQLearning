...
class DeepQ(object):
    ...
    def construct_q_network(self):
        ...
        self.model.add(Convolution2D(32, 8, 8, subsample=(4, 4), input_shape=(new_size_width, new_size_height, NUM_FRAMES)))
        ...
        self.target_model.add(Convolution2D(32, 8, 8, subsample=(4, 4), input_shape=(new_size_width, new_size_height, NUM_FRAMES)))
